...
def on_message(mosq, obj, msg):
    ...
    try:
      ...
      new_data = (dt_string, device, m_in['v'], m_in['i'], m_in['active_power'], m_in['reactive_power'], m_in['apparent_power'], m_in['pf'], m_in['freq'])
      ...
      connection.commit()
      # 紀錄現在UnixTimestamp
      fp = open("connect.txt", "w")
      fp.write( str(round(time.time())) )
      fp.close()
