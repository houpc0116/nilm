...
def showResult(request):
	if request.method == "POST":
            ...
            output = subprocess.getoutput("python /home/houpc16/nilmtk_test/GRU_iawe_clothes_iron.py > /home/houpc16/nilmtk_test/result.txt")
            #讀取檔案
            f = open('/home/houpc16/nilmtk_test/result.txt')
            for line in f:
