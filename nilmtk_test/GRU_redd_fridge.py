...
train = DataSet('/home/houpc16/dataset/redd_2.h5')
...
test = DataSet('/home/houpc16/dataset/redd_2.h5')
test.set_window(start="01-05-2011")
test.set_window(end="20-05-2011")
test_elec = test.buildings[1].elec
test_mains = test_elec.mains().all_meters()[1]

disag_filename = '/home/houpc16/GRU/disag_redd_fridge.h5' # The filename of the resulting datastore
...
predicted.plot()
ground_truth.plot()
plt.savefig('/home/houpc16/djangoenv/nilmProject/static/analyze/GRU_redd_fridge.png', dpi=100)
plt.show()
