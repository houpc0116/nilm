...
train = DataSet('/home/houpc16/dataset/iawe_2.h5')
test = DataSet('/home/houpc16/dataset/iawe_2.h5')
meter_key = 'fridge'
...
print("========== DISAGGREGATE ============")
disag_filename = "/home/houpc16/GRU/disag_iawe_fridge.h5"
...
ground_truth.plot()
#fig = plt.gcf()
plt.savefig('/home/houpc16/djangoenv/nilmProject/static/analyze/GRU_iawe_fridge.png', dpi=100)
