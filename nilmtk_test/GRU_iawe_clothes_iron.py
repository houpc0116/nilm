...
train = DataSet('/home/houpc16/dataset/iawe.h5')
test = DataSet('/home/houpc16/dataset/iawe.h5')
...
print("========== DISAGGREGATE ============")
disag_filename = "/home/houpc16/GRU/disag_iawe_clothes_iron.h5"
...
ground_truth.plot()
#fig = plt.gcf()
#plt.savefig('GRU_iawe_clothes_iron.png', dpi=100)
