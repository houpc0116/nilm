...
print("========== OPEN DATASETS ============")
train = DataSet('/home/houpc16/dataset/ukdale_1.h5')
test = DataSet('/home/houpc16/dataset/ukdale_1.h5')
...
print("========== DISAGGREGATE ============")
disag_filename = "/home/houpc16/GRU/disag_ukdale_microwave.h5"
...
predicted.plot()
ground_truth.plot()
plt.savefig('/home/houpc16/djangoenv/nilmProject/static/analyze/GRU_ukdale_microwave.png', dpi=100)
plt.show()
