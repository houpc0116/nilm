...
# load package NILM package
sys.path.append('/home/houpc16/nilmtk/nilmtk')
...
train = DataSet('/home/houpc16/nilmtk_test/iawe.h5')
test = DataSet('/home/houpc16/nilmtk_test/iawe.h5')
...
for i in range(3):
    ...
    epochs += 1
    disaggregator.export_model("/home/houpc16/nilmtk_test/UKDALE-GRU-h{}-{}-{}epochs_iawe.h5".format(train_building,
                                                        meter_key,
                                                        epochs))
end = time.time()
...
print("========== DISAGGREGATE ============")
disag_filename = "/home/houpc16/nilmtk_test/disag_iawe_clothes_iron.h5"
...
plt.show()
#plt.draw()
#fig.savefig('GRU_iawe_clothes_iron.png', dpi=100)
