...
print("========== OPEN DATASETS ============")
train = DataSet('/home/houpc16/dataset/ukdale.h5')
test = DataSet('/home/houpc16/dataset/ukdale.h5')
...
print("========== DISAGGREGATE ============")
disag_filename = "/home/houpc16/GRU/disag_ukdale_washer_dryer.h5"
...
predicted.plot()
ground_truth.plot()
plt.savefig('/home/houpc16/djangoenv/nilmProject/static/analyze/GRU_ukdale_washer_dryer.png', dpi=100)
plt.show()
